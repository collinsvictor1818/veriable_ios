...
extension AppEnvironment {
    ...
    static func bootstrap() -> AppEnvironment {
        ...
        let cartRepository = CartRepository(apiClient: apiClient, secureStorage: secureStorage)
        ...
        let checkoutUseCase = CheckoutUseCase(cartRepository: cartRepository, apiClient: apiClient)
