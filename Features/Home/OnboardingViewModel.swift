    ...
    private func completeOnboarding() {
        ...
        Task {
            do {
                ...
                let user = try await userRepository.createAccount(name: name, email: email, password: password)
                ...
                await MainActor.run {
                    ...
                    if let appError = error as? AppError {
                        ...
                        } else if nsError.localizedDescription.contains("409") || nsError.localizedDescription.contains("duplicate") || nsError.localizedDescription.contains("already exists") {
